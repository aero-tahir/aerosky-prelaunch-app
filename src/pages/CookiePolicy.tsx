    ...
    <div className="relative pt-24 pb-16 px-4 sm:px-6 md:px-12 lg:px-24">
      ...
      <div className="max-w-3xl mx-auto">
        <header className="mb-10 text-center sm:text-left">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-sky-500/20 bg-sky-500/[0.04] text-[10px] font-mono font-bold tracking-widest text-sky-400 uppercase mb-4">
