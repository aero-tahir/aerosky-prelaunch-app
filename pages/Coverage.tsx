      ...
      <div className="relative z-10 px-6 md:px-12 py-8 max-w-4xl">
        <div className="glass-panel p-8 rounded-2xl max-w-2xl">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Coverage Transparency</h1>
              <p className="text-slate-600 dark:text-gray-400">We verify every data point. No estimates without warning.</p>
            </div>
          </div>
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-slate-500 dark:text-gray-400 ml-auto">Verified</span>
            </div>
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-slate-500 dark:text-gray-400 ml-auto">±2km Accuracy</span>
            </div>
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-slate-500 dark:text-gray-400 ml-auto">No Signal</span>
            </div>
          </div>

          <div className="bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl p-6 text-center">
            <Radio size={32} className="mx-auto text-slate-500 dark:text-gray-400 mb-3" />
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Live in a blind spot?</h3>
